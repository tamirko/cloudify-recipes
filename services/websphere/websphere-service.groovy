service {
	...
	lifecycle{	
		...
		details {
			...
			def planetsSampleURL = "${wasURL}/PlantsByWebSphere/"
			println "websphere-service.groovy: planetsSampleURL is ${planetsSampleURL}"
            ...
            return [
                ...
                "Planets Sample":"<a href=\"${planetsSampleURL}\" target=\"_blank\">${planetsSampleURL}</a>" , 
