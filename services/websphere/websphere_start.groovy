...
new AntBuilder().sequential {
	...
	echo(message:"Getting ${websphereConfig.petclinicWarDownloadPath} ...")
	get(src:"${websphereConfig.petclinicWarDownloadPath}",dest:"${websphereConfig.petclinicWarPath}",   skipexisting:true)
